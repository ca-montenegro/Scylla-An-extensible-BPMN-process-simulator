...
public class SimulationManager {
    ...
    public String run() {
        ...
        try {
            ...
            //outputPath = strb.substring(0,strb.lastIndexOf(Scylla.FILEDELIM)+1)+"output_"+new SimpleDateFormat("yy_MM_dd_HH_mm").format(new Date())+ Scylla.FILEDELIM;
            outputPath = strb.substring(0,strb.lastIndexOf(Scylla.FILEDELIM)+1)+"output"+ Scylla.FILEDELIM;
